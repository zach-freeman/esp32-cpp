...
app_gap_cb_t BluetoothDriver::m_dev_info;
...
void BluetoothDriver::startUp()
{
    ...
    esp_bt_gap_register_callback(bluetoothAppGapCallback);
...
void BluetoothDriver::bluetoothAppGapCallback(esp_bt_gap_cb_event_t event, esp_bt_gap_cb_param_t *param)
{
    app_gap_cb_t *p_dev = &m_dev_info;
    char bda_str[18];
    char uuid_str[37];
...
void BluetoothDriver::updateDeviceInfo(esp_bt_gap_cb_param_t *param)
{
    char bda_str[18];
    uint32_t cod = 0;
...
char *BluetoothDriver::bda2str(esp_bd_addr_t bda, char *str, size_t size)
{
...
char *BluetoothDriver::uuid2str(esp_bt_uuid_t *uuid, char *str, size_t size)
{
...
bool BluetoothDriver::getNameFromEir(uint8_t *eir, uint8_t *bdname, uint8_t *bdname_len)
{
